    ...
    return BaseView.extend({
        ...
        initialize: function() {
            ...
            if (this.model.get('id') !== undefined) {
                this.interviewEditModel = new InterviewEditModel({
        ...
        render: function() {
            var self = this,
                addUserText = (this.model.get('id')) ? "Save" : "Add new interview",
                title = (this.model.get('id')) ? "Update interview detail" : "Add new interview detail";
